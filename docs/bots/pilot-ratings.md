...
- `dataset.jsonl`: model-ready raw outcomes and a deterministic provenance header (bot
  source hashes/search budgets, complete config, map, seed schedule, and sample size);

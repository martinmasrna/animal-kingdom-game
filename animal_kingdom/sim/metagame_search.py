...
from ..decks import load_premade_deck, register_deck
...
def run_counter(args, config) -> None:
    ...
    register_deck(GOODSTUFF_SLUG, load_goodstuff(args.goodstuff))
...
def run_expand(args, config) -> None:
    ...
    for rnd in range(1, args.rounds + 1):
        ...
        register_deck(slug, recipe.decklist())
        field.append(slug)

...
from ..decks import BASELINE_DECK
from .runner import BOT_KINDS, run_pairs

# The yardstick rig is `decks.BASELINE_DECK`: 30 distinct self-sufficient cards, 1 copy each, ordered
# 18 common / 8 rare / 4 legendary.
DECKLIST = BASELINE_DECK
COMMONS, RARES, LEGENDARIES = DECKLIST[:18], DECKLIST[18:26], DECKLIST[26:]
